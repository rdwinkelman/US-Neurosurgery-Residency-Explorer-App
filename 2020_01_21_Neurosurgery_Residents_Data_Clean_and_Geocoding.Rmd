...
resident_data <- read_excel(here(path= "Neurosurgery Residency Program App","2020_10_11_US_Neurosurgery_Residents.xlsx")) %>%
  clean_names() %>%
  left_join(website_links,by="program")

# program_ranking <- read_excel("2020_07_5_US_Neurosurgery_Residents_w_ranking.xlsx",
#                               sheet="Program Ranking") %>%
#   clean_names() %>%
#   rename(program = neurosurgery_program,
#          rank_program = rank)
# 
# med_school_ranking <- read_excel("2020_07_5_US_Neurosurgery_Residents_w_ranking.xlsx",
#                               sheet="Med School Ranking") %>%
#   clean_names() %>%
#   rename(rank_medical_school = rank)
```
...
final_resident_data_w_geo_code %>%
  write_rds(here(path="Neurosurgery Residency Program App",
                 "2020_10_31_resident_data_w_geo_code.rds"))
# final_resident_data_w_geo_code %>%
#   write_csv(here(path="Neurosurgery Residency Program App","resident_data_w_geo_code.csv"))
```
